  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>CodingClub</b> Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form action="http://localhost/~leehojun/CC/codingclub/Mvctest/login" method="post">
          <div class="form-group has-feedback">
            <input type="email" name="user_id" class="form-control" placeholder="Email">
