    ...
    <nav class="navbar  navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://codingclubs.org"><strong>주니어</strong> 썸머 캠프</a>
        </div>
            ...
            <div class="summer_iot" id="iot">
				...
				<div class="summary_iot">
					...
					<div class="introduction">
						<h4>소개</h4>
						<p>
							<i>아두이노 기반의 피지컬 컴퓨팅 도구를 소프트웨어로 프로그래밍하여 우리 생활에서 사용하고 즐길 수 있는 사물인터넷 제품을 
직접 기획하고 개발하고 만드는 IoT메이커, IoT디자이너, IoT해커 3개과정 중 첫번째 프로그램!</i>
							<span>MIT 스크래치, 앱인벤터를 아두이노 기반의 소형 컴퓨터, 메이키메이키, 비트브릭, 비트블록 등의 피지컬 컴퓨팅 도구와 연결하여 우리 생활에서 사용할 수 있는 다양한 사물인터넷 기반 제품을 친구들과 함께 직접 만드는 코딩클럽 주니어들의 여름방학 모임</span>
							<span>회로, 입출력, 센서 등 소프트웨어로 작동하는 하드웨어의 원리를 이해하고, 함수, 변수 등 기초 컴퓨터과학을 적용한 프로그래밍을 통해 스마트램프, 게임기, 라인트레이서 등 나만의 IoT 제품을 직접 만드는 시간</span>
						</p>
					</div>
				</div>
            ...
            <p class="privacy">
						...
						<ul class="form-cont">
							<li class="form-id">
								...
								<p>
								<input type="text" class="form-control" name="account_id" id="account_id" placeholder="codingclub@gmail.com">										
								</p> 
								<label>PWD <i>*</i></label>
								<input type="password" class="form-control" name="passwd1" id="passwd1" placeholder="비밀번호입력">
								<label>PWD 확인 <i>*</i></label>
								<input type="password" class="form-control" name="passwd2" id="passwd2" placeholder="비밀번호확인">
							</li>
							<li>
								<label>참여신청학부모 성명 <i>*</i></label>
								<input type="text" class="form-control" name="pname" id="pname" placeholder="학생이 아닌 학부모님 성함을 기입해주십시오">
								<label>참여신청학부모 전화번호 <i>*</i></label>
								<input type="text" class="form-control" name="php" id="php" placeholder="예: 010-3245-8095, 필히 XXX-XXXX-XXXX 형태로 연락을 위해 정확히 부탁 드립니다.">
							...
							<li>
								...
								<input type="text" class="form-control" name="name" id="name" placeholder="학생이름">
								...
								<input type="text" class="form-control" name="school" id="school" placeholder="학교이름 예) 코딩초등학교">
							</li>
							<li>
								<label>8월 주니어소프트웨어클럽 썸머캠프 참가신청 프로그램<br>(2개반 신청 시 복수 선택해 주세요)<i>*</i></label>
								<div class="checkbox">
								<label><input type="checkbox" name="course_idx1" id="course_idx1" value="20" > 주니어메이커</label>
								<label><input type="checkbox" name="course_idx2" id="course_idx2" value="21" > IoT메이커</label>
								<label><input type="checkbox" name="course_idx3" id="course_idx3" value="22" > 앱메이커</label>
								</div>
